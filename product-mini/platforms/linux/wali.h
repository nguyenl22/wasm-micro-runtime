...
long wali_syscall_clock_gettime (wasm_exec_env_t exec_env);
long wali_syscall_clock_getres (wasm_exec_env_t exec_env);
long wali_syscall_clock_nanosleep (wasm_exec_env_t exec_env);
...
long wali_syscall_statx (wasm_exec_env_t exec_env);
